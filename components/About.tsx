...
const CoordinatorCard = ({ title, icon, iconColor, bulletPoints }: CoordinatorCardProps) => {
  return (
    <div className="bg-muted dark:bg-muted rounded-lg shadow-sm p-6">
  ...
  return (
    <section id="about" className="py-20 bg-background w-full">
      <div className="container mx-auto px-4">
        <div className="text-left pl-10 xl:pl-28 mb-12">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="relative aspect-square max-w-md max-h-md mx-auto">
            <Image
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-6 w-full flex-wrap">
              <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 py-5 max-w-[74rem] mx-auto">
      <CoordinatorCard
